...
import { IPositionManagerLike, IUniversalRouterLike } from "../interfaces/UniswapV4Interfaces.sol";
...
library UniswapV4Lib {
    ...
    function _approveWithPermit2(
        ...
        internal
    {
        require(amount <= type(uint160).max, "UniswapV4Lib/amount-too-large-for-permit2");
