...
library RateLimitHelpers {
    ...
    function makeSpokeReserveHubAssetKey(bytes32 key, address spoke, uint256 reserveId, address hub, uint16 assetId, address asset) internal pure returns (bytes32) {
        return keccak256(abi.encode(key, spoke, reserveId, hub, assetId, asset));
    }
